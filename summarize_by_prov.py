...
# #############################
result_df.to_csv(os.path.join(dest_folder,r'izs-dati/ESITI_PROV_GIORNALIERI_'+str(data_aggiornamento)+'.csv'), index=None)
result_df.to_csv(os.path.join(dest_folder,r'izs-dati/ESITI_PROV_GIORNALIERI_LATEST.csv'), index=None)